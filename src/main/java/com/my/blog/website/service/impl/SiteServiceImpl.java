...
public class SiteServiceImpl implements ISiteService {
    ...
    public List<Map<String, String>> getAllTags() {
        LOGGER.debug("Enter getAllTags method");
        List<Map<String, String>> archives = contentDao.findAllTags();
        LOGGER.debug("Exit getAllTags method");
        return archives;
    }
